...
vid = webcam("HD User Facing");%Creating a camera object with link to camera

preview(vid);%Previewing camera image
...
for i = 1:1000
    vidFrame = getsnapshot(vid);
    %Capture new frame of video
...
stop(vid);%stopping capturing video from camera
